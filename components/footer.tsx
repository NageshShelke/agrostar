...
export function Footer() {
	return (
		<footer className="relative mx-auto flex w-full max-w-5xl flex-col items-center mb-10 justify-center  border-t bg-[radial-gradient(35%_128px_at_50%_0%,theme(backgroundColor.white/8%),transparent)] px-4 py-6 md:rounded-t-6xl">
			...
			<div className="grid w-full gap-8 xl:grid-cols-3 xl:gap-8">
				<AnimatedContainer className="space-y-4">
					...
					<p className="mt-8 text-muted-foreground text-sm md:mt-0">
						&copy; {new Date().getFullYear()} Agrostar, All rights reserved
					</p>
				</AnimatedContainer>
